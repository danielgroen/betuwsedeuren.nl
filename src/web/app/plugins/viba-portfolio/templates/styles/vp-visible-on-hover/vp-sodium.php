<?php
/**
 * Viba Portfolio Visible On Hover Sodium Style
 *
 * @package 	Viba_Portfolio/Styles/Visible_On_Hover/Sodium
 * @since 	    1.0
 * @author 		apalodi
 */
...
echo '<div class="viba-portfolio-cover-wrapper">';
	...
	if ( is_viba_portfolio_info( array( 'zoom-button', 'link-button' ) ) ) :
		...
		echo '<div class="viba-portfolio-cover viba-portfolio-js-width"'.
				/**
...
if ( is_viba_portfolio_info( array( 'likes', 'title', 'categories', 'description' ) ) ) :
	...
	echo '<div class="viba-portfolio-content viba-portfolio-sodium-content viba-portfolio-arrow"'.
		/**
