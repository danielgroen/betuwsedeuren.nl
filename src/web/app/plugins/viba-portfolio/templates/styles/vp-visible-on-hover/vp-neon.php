<?php
/**
 * Viba Portfolio Visible On Hover Neon Style
 *
 * @package 	Viba_Portfolio/Styles/Visible_On_Hover/Neon
 * @since 	    1.0
 * @author 		apalodi
 */
...
if ( is_viba_portfolio_info( array( 'likes', 'title', 'categories', 'description' ) ) ) :
	...
	echo '</div><!-- .viba-portfolio-content.viba-portfolio-content-neon -->';
