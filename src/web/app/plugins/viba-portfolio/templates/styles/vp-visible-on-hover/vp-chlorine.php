<?php
/**
 * Viba Portfolio Visible On Hover Chlorine Style
 *
 * @package 	Viba_Portfolio/Styles/Visible_On_Hover/Chlorine
 * @since 	    1.0
 * @author 		apalodi
 */
	...
	if ( is_viba_portfolio_info() ) :
		...
		echo '<div class="viba-portfolio-cover">';
			echo '<div class="viba-portfolio-cover-content"'.
				...
				if ( is_viba_portfolio_info( array( 'categories', 'likes', 'zoom-button', 'link-button' ) ) ) :
				echo '<div class="viba-portfolio-chlorine-content">';
					viba_portfolio_item_categories();
					if ( is_viba_portfolio_info( array( 'likes', 'zoom-button', 'link-button' ) ) ) :
					echo '<div class="viba-portfolio-chlorine-content-right">';
						viba_portfolio_likes();
						viba_portfolio_item_buttons();
					echo '</div><!-- .viba-portfolio-chlorine-content-right -->';
					endif;
				echo '</div><!-- .viba-portfolio-chlorine-content -->';
				endif;
