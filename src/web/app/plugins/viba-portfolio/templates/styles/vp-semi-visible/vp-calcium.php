<?php
/**
 * Viba Portfolio Semi Visible Calcium Style
 *
 * @package 	Viba_Portfolio/Styles/Semi_Visible/Calcium
 * @since 	    1.0
 * @author 		apalodi
 */
	...
	if ( is_viba_portfolio_info() ) :
		...
		echo '<div class="viba-portfolio-cover-fixed">';
			echo '<div class="viba-portfolio-cover-content"'.
				...
				if ( is_viba_portfolio_info( array( 'likes', 'categories', 'description', 'zoom-button', 'link-button' ) ) ) :
