<?php
/**
 * Viba Portfolio Semi Visible Default Style
 *
 * @package 	Viba_Portfolio/Styles/Semi_Visible/Default
 * @since 	    1.0
 * @author 		apalodi
 */
	...
	if ( is_viba_portfolio_info( array( 'zoom-button', 'link-button', 'likes', 'categories', 'description' ) ) ) :
		...
		echo '<div class="viba-portfolio-cover"'.
				/**
			 	 ...
			 	 *
			  	 * @hooked viba_portfolio_cover_content_inline_styles - 10
			 	 */
...
if ( is_viba_portfolio_info( 'title' ) ) :
	...
	echo '<div class="viba-portfolio-content">';
