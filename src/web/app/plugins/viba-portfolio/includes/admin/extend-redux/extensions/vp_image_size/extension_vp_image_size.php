...
// Don't duplicate me!
if( !class_exists( 'ReduxFramework_Extension_vp_image_size' ) ) {
     ...
     * @since       3.1.6
     */
    class ReduxFramework_Extension_vp_image_size extends ReduxFramework {
