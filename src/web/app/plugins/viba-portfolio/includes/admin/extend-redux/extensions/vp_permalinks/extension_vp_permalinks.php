...
// Don't duplicate me!
if( !class_exists( 'ReduxFramework_Extension_vp_permalinks' ) ) {
     ...
     * @since       3.1.6
     */
    class ReduxFramework_Extension_vp_permalinks extends ReduxFramework {
